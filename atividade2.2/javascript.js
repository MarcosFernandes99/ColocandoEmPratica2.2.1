let noteLevel = document.getElementsByClassName('level')
let star = document.getElementsByClassName('star')

function selectLevel(e) {
    for (let i = 0; i < 10; i++) {
        noteLevel[i].style.backgroundColor = '#fff'
    }
...
for (let i = 0; i < noteLevel.length; i++) {
    noteLevel[i].addEventListener('click', selectLevel)
}
